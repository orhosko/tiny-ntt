...
async def test_identity_twiddle(dut):
    ...
    for a, b in test_cases:
        a_out, b_out = await apply_and_capture(dut, a, b, 1)
...
async def test_zero_twiddle(dut):
    ...
    for a, b in test_cases:
        a_out, b_out = await apply_and_capture(dut, a, b, 0)
...
async def test_basic_butterfly(dut):
    ...
    for a, b, twiddle, exp_a, exp_b in test_cases:
        a_out, b_out = await apply_and_capture(dut, a, b, twiddle)
...
async def test_symmetry(dut):
    ...
    for a, b, twiddle in test_pairs:
        # Original
        a_out1, b_out1 = await apply_and_capture(dut, a, b, twiddle)
